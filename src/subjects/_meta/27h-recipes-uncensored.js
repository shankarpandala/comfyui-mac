...
export default subj({
  ...
  status: 'published',
  chapters: [
    chPub('c1-why-local', 'Why Local Matters', [
      ['s1-hosted-vs-local', 'Hosted Moderation vs Local Freedom'],
    ], 20, 'beginner'),
    chPub('c2-responsible-use', 'Responsible-Use Checklist', [
    ...
    chPub('c3-sdxl-bases', 'SDXL Uncensored Bases', [
      ['s1-pony', 'Pony Diffusion v6'],
      ['s2-illustrious', 'Illustrious-XL'],
      ['s3-noobai', 'NoobAI-XL'],
      ['s4-lustify', 'Lustify'],
    ], 35),
    chPub('c4-sd15-bases', 'SD1.5 Uncensored Bases', [
      ['s1-survey', 'Survey'],
    ], 20),
    chPub('c5-flux-uncensored', 'FLUX Uncensored Finetunes', [
      ['s1-mac-compat', 'Mac Compatibility Table'],
    ], 25, 'advanced'),
    chPub('c6-video-uncensored', 'Hunyuan / Wan Uncensored LoRAs', [
      ['s1-mac-feasibility', 'Mac Feasibility'],
      ['s2-recipes', 'Video Uncensored Recipes'],
    ], 35, 'advanced'),
    chPub('c7-prompt-style', 'Prompt-Style Differences', [
      ['s1-booru-vs-natural', 'Booru Tags vs Natural Language'],
    ], 25),
    chPub('c8-detailers', 'Anatomy Fidelity', [
      ['s1-negative-detailer', 'Negative + Detailer Recipes'],
    ], 25, 'advanced'),
    chPub('c9-self-uncensored', 'Self-Clone + Uncensored Stack', [
