...
export default subj({
  ...
  difficulty: 'advanced',
  chapters: [
    ch('c1-ltx-t2v', 'LTX-Video t2v', [
      ['s1-ltx-097', 'LTX 0.9.7 Recipe'],
    ], 25),
    ch('c2-animatediff-t2v', 'AnimateDiff t2v', [
      ['s1-sdxl-motion', 'AnimateDiff SDXL + Motion LoRA'],
    ], 30),
    ch('c3-hunyuan-t2v', 'Hunyuan t2v', [
      ['s1-gguf-q4', 'Hunyuan GGUF Q4 t2v'],
    ], 35),
    ch('c4-wan-t2v', 'Wan 2.2 t2v', [
      ['s1-wan22-5b', 'Wan 2.2 5B t2v'],
    ], 30),
    ch('c5-cog-t2v', 'CogVideoX-5B t2v', [
      ['s1-cog-recipe', 'CogVideoX Recipe'],
    ], 25),
    ch('c6-svd-bridge', 'SVD Bridged t2v', [
