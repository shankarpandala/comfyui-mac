...
export default subj({
  ...
  difficulty: 'advanced',
  chapters: [
    ch('c1-cn-per-frame', 'ControlNet per Frame', [
      ['s1-depth-pose-canny', 'Depth, Pose, Canny per Frame'],
    ], 30),
    ch('c2-optical-flow', 'Optical Flow', [
      ['s1-raft', 'RAFT for Consistency'],
    ], 25, 'research'),
    ch('c3-vace', 'VACE Editing', [
      ['s1-vace-recipe', 'VACE Recipe'],
    ], 25, 'advanced'),
    ch('c4-rife-film', 'RIFE / FILM Frame Interpolation', [
      ['s1-rife', 'RIFE'],
      ['s2-film', 'FILM'],
      ['s3-fps-uplift', '8 fps → 24/30 fps Pipeline'],
    ], 30),
    ch('c5-svd', 'Stable Video Diffusion', [
      ['s1-svd', 'SVD / SVD-XT'],
    ], 25),
  ],
})
