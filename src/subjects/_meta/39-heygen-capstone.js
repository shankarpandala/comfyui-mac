...
export default subj({
  ...
  status: 'published',
  chapters: [
    chPub('c1-overview', 'HeyGen vs This Build', [
    ...
    chPub('c2-architecture', 'System Architecture', [
    ...
    chPub('c3-research-stage', 'Stage 1 — Research Agent', [
    ...
    chPub('c4-script-stage', 'Stage 2 — Script Agent', [
    ...
    chPub('c7-edit-stage', 'Stage 5 — Edit & Assemble', [
    ...
    chPub('c8-orchestrator', 'Stage 6 — The Orchestrator', [
    ...
    chPub('c12-publishing', 'Publishing Loop', [
    ...
    chPub('c13-evaluation', 'Quality Evaluation', [
    ...
    chPub('c14-responsible', 'Responsible Operation', [
