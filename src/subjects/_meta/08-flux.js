...
export default subj({
  ...
  status: 'published',
  chapters: [
    chPub('c1-architecture', 'FLUX Architecture', [
    ...
    chPub('c2-variants', 'Dev vs Schnell vs Pro', [
      ['s1-dev', 'FLUX Dev'],
      ['s2-schnell', 'FLUX Schnell (4-step distill)'],
      ['s3-pro-availability', 'FLUX Pro Availability'],
    ], 30),
    chPub('c3-fp8-trap-on-mac', 'The fp8 Trap on Mac', [
    ...
    chPub('c4-gguf-on-mac', 'FLUX GGUF on Mac', [
    ...
    chPub('c5-tuning', 'Tuning FLUX on Mac', [
    ...
    chPub('c6-control-variants', 'FLUX Control Variants', [
      ['s1-redux', 'FLUX Redux (Image Prompt)'],
      ['s2-fill', 'FLUX Fill (Inpaint)'],
      ['s3-canny-depth', 'FLUX Canny and Depth'],
    ], 50),
    chPub('c7-schnell-recipes', 'Schnell 4-Step Recipes', [
