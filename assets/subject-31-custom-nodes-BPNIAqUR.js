import{j as e}from"./vendor-CumJrUdK.js";import{D as n,N as i,C as t}from"./subject-01-comfyui-fundamentals-CxYg6t9x.js";function s(){return e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"ComfyUI custom nodes are Python classes following a specific contract. Three class attributes (INPUT_TYPES, RETURN_TYPES, FUNCTION) plus a method to do the work. That's it."}),e.jsx(n,{title:"The minimal node",children:e.jsx("pre",{children:`class HelloNode:
    @classmethod
    def INPUT_TYPES(cls):
